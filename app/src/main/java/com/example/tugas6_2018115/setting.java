...
import static com.example.tugas6_2018115.DBmain.TABLENAME;
...
import com.example.tugas6_2018115.databinding.SettingBinding;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(setting.this, "Data Inserted", Toast.LENGTH_SHORT).show();
...
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(setting.this, DisplayData.class));
            }
        });
//for storing new data or update data
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(setting.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
...
//edit hide and submit visible
                    ...
                    Intent a = new Intent(setting.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
